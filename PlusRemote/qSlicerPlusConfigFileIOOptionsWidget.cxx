  ...
  : qSlicerIOOptionsWidget(new qSlicerPlusConfigFileIOOptionsWidgetPrivate, parentWidget)
{
  ...
  connect(d->AutoConnectCheckBox, SIGNAL(toggled(bool)),
          this, SLOT(updateProperties()));
  connect(d->LauncherNodeComboBox, SIGNAL(currentNodeChanged(vtkMRMLNode*)),
    this, SLOT(updateProperties()));
}
...
void qSlicerPlusConfigFileIOOptionsWidget::updateProperties()
{
  ...
  d->Properties["autoConnect"] = d->AutoConnectCheckBox->isChecked();
  d->Properties["launcherNodeID"] = d->LauncherNodeComboBox->currentNodeID();
}
